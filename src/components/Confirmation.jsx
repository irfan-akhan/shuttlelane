        ...
        <Grid item container style={{ border: "1px solid #ccc" }}>
          {booking?.days ? (
            <Typography variant="paragraph" className={success.message}>
              Thank You for your Car Hire booking with Shuttlelane. <br />
              `We'll now check the availibility of your preferred car and we
            ...
            <Typography variant="paragraph" className={success.message}>
              Thank You for your Priority Pass booking with Shuttlelane.
            </Typography>
          )}
                ...
                >
                  ...
                  {booking?.arrivalDate ? (
                    <Typography variant="paragraph" className={success.para}>
                      ...
                      Meeting Point: Proceed to trolly stand behind Baggage
                      Conveyor for your free trolley and porter service.
                    </Typography>
                  ) : (
                    ""
                  )}
