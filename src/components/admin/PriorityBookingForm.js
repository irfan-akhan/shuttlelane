...
const PriorityBookingForm = ({ closeForm }) => {
  ...
  useEffect(() => {
    ...
    if (selectedClass) {
      ...
      setInputValues({
        ...
        amount: parseFloat(calAmount * inputValues.passengers).toFixed(2),
      });
    }
        ...
        >
          <form onSubmit={onSubmitHandler} className={styles.form}>
            <div className={styles.inputGroup}>
              <label htmlFor="formType">Service Type</label>
              <select onChange={onChangeHandler} name="service" id="service">
            ...
            <div className={styles.inputGroup}>
              <label htmlFor="pickupAirport">Select Airport</label>
              <select onChange={onChangeHandler} name="airport" id="airport">
                <option value="" selected disabled>
                  Select Airport
                </option>
...
required
                ...
                name="flightNumber"
                onChange={onChangeHandler}
                value={inputValues.flightNumber?.toUpperCase()}
              />
            </div>
            <div className={styles.inputGroup}>
              ...
              <input
                ...
                onChange={(e) => {
                  const amount =
                    classes?.filter(
                      (item) => item.name == inputValues?.cabinClass
                    )[0]?.rate * parseInt(e.target.value);
