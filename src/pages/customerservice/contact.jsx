...
const contact = () => {
	...
	return (
		<section className={about.container}>
			<Head>
				<title>Contact us - Customer Services | Shuttlelane.com</title>
				<meta
					name='viewport'
			...
			<Grid container justifyContent='center' spacing={3}>
				...
				<Grid item xs={11} sm={7} xl={5}>
					...
					<Typography variant='body1' paragraph color='textSecondary'>
						Our office is located at No. 2, Martins Street, Off
						Ojuelegba Road, Yaba, Lagos, Nigeria.
					</Typography>
					<Typography variant='body1' paragraph color='textSecondary'>
						If you wish to get in touch with us, kindly use the
					...
					<Typography variant='body1' paragraph color='textSecondary'>
						For general enquiries, please allow up to 24 hours to
						receive a response.
					</Typography>
				</Grid>
				<Grid item xs={12}>
