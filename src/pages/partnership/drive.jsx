...
export default class drive extends Component {
	...
	render() {
		return (
			...
			>
				<Head>
					<title>Drive for us - Partnership | Shuttlelane.com</title>
					<meta
						name='viewport'
				...
				<Grid xs={10} sm={8} xl={5} item style={{ marginTop: '6rem' }}>
					...
					<Typography variant='body1'>
						We are proud to be widely regarded as the best in the
						business and we’re always on the lookout for new driving
						talent to join our team.
					</Typography>
					<Typography variant='body1'>
						We demand a very high standard of service from our
						drivers, but in return we offer flexibility and great
						rates.
					</Typography>
