...
const Search = (props) => {
  ...
  useEffect(() => {
    ...
    fetch("https://shuttlelane.com/api/booking/search", {
      method: "POST",
      headers: {
  ...
  return booking ? (
    ...
    >
      {modal && (
        <section className={success.modal}>
          <Cancel onClick={onCloseHandler} className={success.close} />
                ...
                >
                  ...
                  {booking?.arrivalDate ? (
                    <Typography variant="paragraph" className={success.para}>
                      ...
                      <strong>Meeting Point:</strong> Proceed to trolly stand
                      behind Baggage Conveyor for your free trolley and porter
                      service.
                    </Typography>
                  ) : (
                    ""
            ...
            <div className={success.detailContainer} style={{ width: "100%" }}>
                ...
                >
                  ...
                  <Typography variant="paragraph" className={success.para}>
                    ...
                    booking?.assignedDriver.length > 0
                      ? booking?.assignedDriver[0].name
                      : "Assigning a Driver"}
                  </Typography>
                  <br />
                  <Typography variant="paragraph" className={success.para}>
                    <strong style={{ color: "#212121" }}>Number:&nbsp;</strong>
                    {booking.assignedDriver && booking.assignedDriver.length > 0
                      ? booking.assignedDriver[0].mobile
                      : "Assigning a Driver"}
                  </Typography>
                </div>
              </div>
              ...
              <div className={success.itemDetails}>
                ...
                >
                  ...
                  <br />
                  <Typography variant="paragraph" className={success.para}>
                    <strong style={{ color: "#212121" }}>Type:&nbsp; </strong>
                    {booking?.assignedCar && booking?.assignedCar.length > 0
                  ...
                  <Typography variant="paragraph" className={success.para}>
                    ...
                    {booking?.assignedCar && booking?.assignedCar.length > 0
                      ? booking?.assignedCar[0].plateNumber
                      : "Not Assigned yet"}
                    <br />
                  </Typography>
                  <Typography variant="paragraph" className={success.para}>
                    <strong style={{ color: "#212121" }}>Color:&nbsp;</strong>
                    {booking?.assignedCar && booking?.assignedCar.length > 0
              ...
              <>
                <div className={success.itemDetails}>
                  ...
                  >
                    ...
                    <br />
                    <Typography variant="paragraph" className={success.para}>
                      {booking?.pickupDate || booking?.arrivalDate
                        ? booking?.pickupDate
                          ? booking?.pickupDate.toString().slice(0, 10)
                          : booking?.arrivalDate
                          ? booking?.arrivalDate.toString().slice(0, 10)
                          : booking?.arrivalDate.toString().slice(0, 10)
                        : ""}
                      &nbsp;{booking?.time}
                    </Typography>
                ...
                <div className={success.itemDetails}>
                  ...
                  >
                    ...
                    <Typography variant="paragraph" className={success.para}>
                      ...
                      {parseInt(booking.passengers) > 1 ? "s" : ""} in total
                    </Typography>
                  </div>
                </div>
                <div className={success.itemDetails}>
    ...
    <section>
      ...
      >
        ...
        <Grid item xs={12} sm={8} md={6} xl={4} className={styles.headerError}>
        ...
        >
          <Typography variant="paragraph" className={styles.message}>
            ...
            We are sorry but we couldn't find any booking under this Reference
            Number.To make a Booking visit{" "}
            <a href="/" color="#000080">
              shuttlelane
            </a>
          </Typography>
