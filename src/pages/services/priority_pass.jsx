...
const priority_pass = () => {
	...
	return (
		<section className={about.container}>
			<Head>
				<title>
					Priority Pass - Shuttlelane Services | Shuttlelane.com
				</title>
				<meta
					name='viewport'
			...
			<Grid container justifyContent='center' spacing={3}>
				...
				<Grid item xs={11} sm={7} xl={5}>
					...
					<Typography variant='body1' paragraph color='textSecondary'>
						Skip security and immigration queues. Getting through
						the airport can be rough, especially when you’re landing
						with bags and an imminent business meeting weighs
						heavily on your mind. For those business travellers
						seeking simplicity, comfort and an assurance that things
						will run smoothly, the Shuttlelane priority pass service
